...
const Home = () => {
  ...
  useEffect(() => {
    ...
    timers.push(setTimeout(() => setShowNewArrivals(true), 500)); // 0.5s later
    timers.push(setTimeout(() => setShowOutfit(true), 1000));     // 1s later
    timers.push(setTimeout(() => setShowPoster(true), 1500));     // 1.5s later
    timers.push(setTimeout(() => setShowFeatured(true), 2000));  // 2s later
