    ...
    const fetchAddresses = async () => {
      ...
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/addresses/my`,
          {
...
const CheckoutSection = ({
  ...
  <div>
    ...
    <button
      ...
      className={` font-home mt-8 w-full bg-green-600 text-white py-2 rounded-lg font-semibold text-lg shadow-md transition duration-300 ease-in-out ${
